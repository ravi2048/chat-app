...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if(handleValidation()) {
            ...
            // console.log(`### Response from Server after REGISTER: ${JSON.stringify(data)}`);
    ...
    const handleValidation = () => {
        ...
        if(username.length <= 3) {
            toast.error(`Username length should be more than 3 characters`);
            return false;
        } else if(email === '') {
            ...
            toast.error(`Confirm Password doesnt matched with Password`);
            return false;
        } else {
            return true;
        }
